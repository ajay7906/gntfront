...
//     if (!isUserRegistered) {
//       if (currentStep !== 'welcome') {
//         if (currentStep === 'getEmail' && !isValidEmail(message)) {
//           setMessages((prev) => [
//             ...prev,
//             { text: 'Please provide a valid email address.', type: 'bot' },
//           ]);
//           setMessage('');
//           return;
//         }

//         if (currentStep === 'getMobile' && !isValidMobile(message)) {
//           setMessages((prev) => [
//             ...prev,
//             { text: 'Please provide a valid 10-digit mobile number.', type: 'bot' },
//           ]);
//           setMessage('');
//           return;
//         }
