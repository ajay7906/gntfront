...
import smple from "./images/crm 1.png"
import smple1 from "./images/crm 2.png"
import smple2 from "./images/crm 3.png"
import smple3 from "./images/crm 4.png"
import smple4 from "./images/crm 5.png"
import smple5 from "./images/crm 6.png"
import smple6 from "./images/crm 7.png"
    ...
    <div className="bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center text-center text-white bg-gradient-to-r from-[#dad6d6] to-indigo-500">
        ...
        <div className="relative z-10 px-4 max-w-4xl mx-auto">
          ...
          At GNTINDIA, we are offering open-source CRM as well as cloud-based 
          CRM and CRM apps for every business.
          </p>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Features of our CRM Development
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              GNTINDIA's tailor-made CRM services are designed to enhance the productivity 
              of customer interactions and strengthen relationships. Our robust CRM system 
              offers a range of features that centralize customer information, streamline workflow 
              processes, and ensure timely and customized service at every touchpoint.
              </p>
            </div>
...
function Solution() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-0">
      <Card
        title="CRM Solutions"
        description="GNTINDIA offers tailored CRM services designed to enhance the productivity 
        of customer interactions and strengthen business relationships. Our comprehensive CRM solutions 
        centralize customer information, streamline workflow processes, and provide insights to drive effective 
        marketing campaigns."
        images={sampleImages}
      />
    </div>
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-0">
      <Cards
        ...
        images={sampleImages}
        description="Welcome to GNTINDIA, your partner in enhancing customer relationships and 
        boosting business productivity through tailor-made CRM solutions. Our robust CRM system 
        is designed to centralize customer information, streamline workflow processes, and provide 
        actionable insights to drive effective marketing campaigns."
      />
    </div> 
  );
}
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <Card
        ...
        images={sampleImages}
        description="GNTINDIA offers specialized CRM app development services designed 
        to enhance customer interactions, streamline business processes, and drive growth. 
        Our robust CRM systems centralize customer information, track interactions, manage sales 
        leads, and automate workflows to ensure timely and customized service at every touchpoint."
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      ...
      <Cards
        ...
        images={sampleImages}
        description="GNTINDIA offers comprehensive CRM platform integration services 
        designed to enhance the productivity of customer interactions, streamline workflow 
        processes, and provide seamless data flow across your business. Our robust CRM systems 
        integrate with various business tools, ensuring that all customer information is centralized and accessible."
...
function SEO() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-0">
      <Card
        title="CRM SEO Services "
        images={sampleImages}
        description="GNTINDIA offers tailor-made CRM services to enhance the productivity 
        of customer contact and upgrade relationships. To ensure your CRM solutions reach 
        the right audience and achieve maximum visibility, our SEO services are designed to 
        optimize your online presence, drive organic traffic, and improve search engine rankings."
...
function Support() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-0">
      <Cards
        title="Support and Maintenance Service for CRM"
        images={sampleImages}
        description="GNTINDIA offers comprehensive support and maintenance services for 
        our robust CRM solutions to ensure they operate at peak efficiency and continue to 
        provide value to your business. Our dedicated team of experts provides ongoing assistance 
        and support to maximize the productivity of customer interactions and streamline workflow processes."
      />
    </div>
  );
}
        ...
        <section className='py-20 bg-gray-50'>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              At GNTINDIA, we follow a comprehensive and structured design cycle to develop 
              CRM solutions that meet the specific needs of our clients. Our process ensures 
              that our CRM systems are robust, efficient, and tailored to enhance customer interactions, 
              streamline workflow processes, and drive growth.
              </p>
            </div>
...
const FAQPage = () => {
  const faqs = [
    {
      question: "What are the benefits of using GNTINDIA CRM solutions?",
      answer: "GNTINDIA's CRM solutions enhance the productivity of customer interactions, streamline workflow processes, and provide timely and customized service. By centralizing customer information, tracking interaction history, managing sales leads, and automating workflows, businesses can improve customer relationships, boost sales conversion rates, and enhance customer support."
    },
    {
      question: "Can GNTINDIA CRM solutions integrate with other business tools?",
      answer: "Yes, GNTINDIA's CRM solutions seamlessly integrate with various business tools such as email marketing platforms, social media channels, and eCommerce platforms. This integration ensures smooth data flow throughout your business, enhancing overall efficiency and effectiveness."
    },
    {
      question: "How does GNTINDIA CRM system handle workflow automation?",
      answer: "Our CRM system automates routine tasks such as data entry, follow-ups, and reminders, reducing manual errors and increasing efficiency. Custom workflows can be created to match specific business processes, ensuring seamless and efficient operations."
    },
    {
      question: "What kind of support do GNTINDIA CRM solutions offer for customer service teams?",
      answer: "GNTINDIA's CRM solutions equip customer support teams with the tools to respond promptly and effectively to inquiries and support requests. The system manages and tracks support tickets, ensuring issues are resolved quickly and to the customer's satisfaction."
    },
