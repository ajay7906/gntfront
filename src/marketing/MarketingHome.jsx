...
import HERO2 from "./images/design3.png";
  ...
  return (
    <div className="w-full">
      <div className="relative h-[50vh] min-h-[300px] max-h-[600px]">
        {/* Mobile Image - viewport width <= 640px */}
        <img
          src={HERO}
          alt="Hero background"
        ...
        {/* Tablet Image - 641px to 768px */}
        <img
          src={HERO1}
          alt="Hero background"
          className="absolute inset-0 w-full h-full object-cover object-center hidden sm:block md:hidden"
          loading="eager"
        />
        ...
        <img
          src={HERO2}
          alt="Hero background"
          className="absolute inset-0 w-full h-full object-cover object-center hidden md:block lg:hidden"
          loading="eager"
        />
        ...
        {/* Extra Large Desktop - 1281px and above */}
        <img
          src={HERO4}
          alt="Hero background"
