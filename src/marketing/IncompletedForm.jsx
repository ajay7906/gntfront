  ...
  return (
    <div className="pt-16">
      <div className="bg-white p-6 rounded shadow-md w-full max-w-lg mx-auto">
        <h2 className="text-2xl font-bold text-center mb-4">Incompleted Task</h2>
        <form onSubmit={handleSubmit}>
          {[
            ...
            { label: "Incompleted Regions", name: "incompletedRegions", placeholder: "Incompleted regions" },
...
export default IncompletedTaskForm;
