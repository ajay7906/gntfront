  ...
  return (
    <div className="pt-16">
      <div className="bg-white p-6 rounded shadow-md w-full max-w-lg mx-auto">
        <h2 className="text-2xl font-bold text-center mb-4">Rejected Task</h2>
        <form onSubmit={handleSubmit}>
          {[
            ...
            { label: "Reject Regions", name: "rejectRegions", placeholder: "Reject regions" },
